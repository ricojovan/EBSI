                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-section">
                                            ...
                                            <input type="text" id="employee-id" class="form-control" placeholder="Enter employee ID">
                                        </div>
                                        <div class="form-section">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-section row">
                                            <div class="col-md-6">
                                                ...
                                                <input type="number" id="absences-days" class="form-control" placeholder="0" min="0">
                                            </div>
                                            <div class="col-md-6">
                                                <label for="number-of-days">Number of Days:</label>
                                                <input type="number" id="number-of-days" class="form-control" placeholder="0" min="0">
                                            </div>
                                        </div>
                                    </div>
                                </div>
